...
String toastMassageInfo="";
String toastMassageError="";
String toastMassageWarning="";
String toastMassageSuccess="";
extension NotificationTypeMessage on NotificationType {
  String get message {
    switch (this) {
      case NotificationType.info:
        return toastMassageInfo;
      case NotificationType.error:
        return toastMassageError;
      case NotificationType.warning:
        return toastMassageWarning;
      case NotificationType.success:
        return toastMassageSuccess;
    }
  }
}
